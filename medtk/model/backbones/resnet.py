...
from medtk.model.utils import kaiming_init, constant_init
from medtk.model.nd import MaxPoolNd
from medtk.model.blocks import BasicBlockNd, BottleneckNd
...
class ResNet(ComponentModule):
    def __init__(self,
        ...
        super(ResNet, self).__init__(conv_cfg, norm_cfg, act_cfg)
        self.dim = dim
        ...
        self.stages_with_dcn = stages_with_dcn
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            # print(layer_name)
            dcn_cfg = self.dcn_cfg if self.stages_with_dcn[i] else None
            res_layer = self._make_layer(self.block, self.inplanes, planes, num_blocks, stride, dilation, dcn_cfg)
