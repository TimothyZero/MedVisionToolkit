    ...
    def _log_info(self, log_dict, runner):
        if runner.mode == 'train':
            ...
            if 'time' in log_dict.keys():
                ...
                log_str += ('time: {:.3f}, network_time: {:.3f}, data_time: {:.3f}, '.format(
                    log_dict['time'], log_dict['network_time'], log_dict['data_time']))
        ...
        for name, val in log_dict.items():
            ...
            if name in [
                'mode', 'Epoch', 'max_epochs', 'iter', 'lr', 'time', 'data_time', 'network_time',
                'memory', 'epoch'
            ]:
                continue
