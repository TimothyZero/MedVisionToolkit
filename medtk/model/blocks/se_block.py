...
class SEBasicBlockNd(BasicBlockNd):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 act_cfg=None):
        super(SEBasicBlockNd, self).__init__(dim, in_planes, planes, stride, groups,
                                             width_per_group, dilation, bias, conv_cfg, norm_cfg, act_cfg)
...
class SEBottleneckNd(BottleneckNd):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 act_cfg=None):
        super(SEBottleneckNd, self).__init__(dim, in_planes, planes, stride, groups,
                                             width_per_group, dilation, bias, conv_cfg, norm_cfg, act_cfg)
        self.se_module = SEModule(dim, planes * self.expansion, reduction=reduction)
